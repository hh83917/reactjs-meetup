Demo site address: [Link](https://reactjs-meetup.firebaseapp.com).
...
* Sortable table.
* Resposiveness for mobile, grid and media queries.
* Input to change meetup group url name so it can work for other groups as well.
* Jest and enzyme snapshots, and flow tests.
* Maybe download members going to the event to CSV file for attendance checkin.
